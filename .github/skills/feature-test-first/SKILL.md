...
description: "Use quando desenvolver feature com TDD, iniciando por teste de Feature (RED -> GREEN -> REFACTOR)."
---
...
4. Cobrir valido/invalido e persistencia quando houver banco.
