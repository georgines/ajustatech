---
name: vuexy-catalogo
description: "Use quando precisar localizar rapidamente referencias Vuexy em `templete/Vuexy/resources`."
---
...
3. Reaplicar no codigo real do projeto (nunca no `templete/`).
