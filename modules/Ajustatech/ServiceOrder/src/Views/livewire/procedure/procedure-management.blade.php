        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12 col-md-8">
                    ...
                    <input class="form-control" type="text" wire:model="name" placeholder="{{ trans('service-order::messages.procedure_name_placeholder') }}">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" type="number" min="0" step="0.01" wire:model="value">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" rows="3" wire:model="description" placeholder="{{ trans('service-order::messages.procedure_description_placeholder') }}"></textarea>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" rows="3" wire:model="helpText" placeholder="{{ trans('service-order::messages.procedure_help_text_placeholder') }}"></textarea>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <input class="form-control" type="url" wire:model="helpImageUrl" placeholder="https://...">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <input class="form-control" type="url" wire:model="helpVideoUrl" placeholder="https://...">
